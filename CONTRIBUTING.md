# Contributing to YouTrack PHP SDK
...
We are trying to keep backwards compatibility breaks in YouTrack PHP SDK to an absolute minimum. Please take this into account when proposing changes.
